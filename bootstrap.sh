...
echo 'Rhel subscription Username: ' $RHEL_USERNAME
...
echo $((++step))') - yum install podman via container-tools'
yum module install -y container-tools

echo $((++step))') - yum install cockpit - browser web console' # to login !!||| user:vagrant / password:vagrant  ||||!!
yum install cockpit
